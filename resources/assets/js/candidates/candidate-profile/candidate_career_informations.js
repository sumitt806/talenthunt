...
$(document).ready(function () {
    $('#countryId, #stateId, #cityId, #educationCountryId, #educationStateId, #educationCityId, #editCountry, #editState, #editCity, #degreeLevelId, #editEducationCountry, #editEducationState, #editEducationCity').
        select2({
            'width': '100%',
        });
            ...
            $.ajax({
                ...
                success: function (data) {
                    $((modalType === 'experience') 
                        ...
                        : ((!modalTypeHasEdit) ? '#educationStateId' : '#editEducationState'))
                        .empty();
