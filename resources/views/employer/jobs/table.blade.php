<table class="table table-striped table-bordered table-responsive-sm" id="jobsTbl">
    <thead>
    <tr>
        ...
        <th scope="col">{{ __('messages.job.is_freelance') }}</th>
        <th scope="col">{{ __('messages.job.hide_salary') }}</th>
