...
{{if !isJobClosed}}
 {{if status == 'Drafted'}}
    <button class="btn btn-warning mr-1 badge job-application-status"><?php echo __('messages.common.drafted') ?></button>
    {{else}}
    ...
    {{/if}}
{{else}}
    <button class="btn btn-danger mr-1 badge job-application-status"><?php echo __('messages.common.closed') ?></button>
{{/if}}
...
<script id="isFreelance" type="text/x-jsrender">
   <label class="custom-switch pl-0">
        <input type="checkbox" name="Is Freelance" class="custom-switch-input isFreelance" data-id="{{:id}}" {{:checked}}>
...
<script id="hideSalary" type="text/x-jsrender">
   <label class="custom-switch pl-0">
        <input type="checkbox" name="Hide Salary" class="custom-switch-input hideSalary" data-id="{{:id}}" {{:checked}}>
        <span class="custom-switch-indicator"></span>
    </label>
