        ...
        <div class="container mTop">
            @if($job->is_suspended || !$isActive)
                <div class="row">
                    <div class="alert alert-warning text-warning bg-transparent" role="alert">
                        Job is <strong> {{\App\Models\Job::STATUS[$job->status]}}.</strong>
                    </div>
                </div>
            @endif
            @if(Session::has('warning'))
                <div class="alert alert-warning" role="alert">
                    {{ Session::get('warning') }}
                    <a href="{{ route('candidate.profile',['section'=> 'resumes']) }}" class="alert-link ml-2 ">Click
                        Here</a> to upload resume.
                </div>
        @endif
            ...
            <div class="row">
                    ...
                    <div class="row mt40">
                        ...
                        <div class="col-md-8 mt15">
                            ...
                            <div class="row mt15">
                                ...
                                <div class="col-md-7">
                                    <h6>{{ ($job->jobsTag->isNotEmpty()) ? $job->jobsTag->pluck('name')->implode(', ') : 'N/A' }}</h6>
                                </div>
                            </div>
                            <div class="row mt15">
                                <div class="col-md-5">
                                ...
                                <div class="col-md-7">
                                    <h6>{{ ($job->jobType) ? $job->jobType->name : 'N/A' }}</h6>
                                </div>
                            </div>
                            @if($job->jobShift)
                                <div class="row mt15">
                            ...
                            <div class="row mt15">
                                ...
                                <div class="col-md-7"><h6>{{ $job->is_freelance == 1 ? 'Yes' : 'No' }}</h6>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-md-4 col-xs-12">
                    ...
                    <div class="job-sidebar">
                        <ul class="job-overview nopadding mt5">
                            <li>
                        ...
                        @else
                            ...
                            <div class="mt20">
                                <button class="btn btn-purple btn-block"
                                        onclick="window.location='{{ route('front.register') }}'">Register to apply
                                </button>
                            </div>
                            @endif
                        @endauth
                                ...
                                <div class="col-md-12 col-sm-12 col-xs-12 mt10">
                                    ...
                                    <h6>
                                        <a href="{{ route('front.company.details', $job->company->unique_id) }}"><span
                                                    class="label label-info mt20">{{ $jobsCount }} Opened Jobs</span></a>
                                    </h6>
                                    <hr/>
                                    <p>
