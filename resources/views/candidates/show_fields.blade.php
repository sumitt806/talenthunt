<div class="row details-page">
    ...
    <div class="form-group col-sm-3">
        ...
        <p>{{ !empty($candidate->career_level_id)?$candidate->careerLevel->level_name:__('messages.common.n/a')}}</p>
    </div>
    <div class="form-group col-sm-3">
        {{ Form::label('industry', __('messages.candidate.industry').':') }}
        <p>{{ !empty($candidate->industry_id)?$candidate->industry->name:__('messages.common.n/a') }}</p>
    </div>
    <div class="form-group col-sm-3">
        {{ Form::label('functional_area', __('messages.candidate.functional_area').':') }}
        <p>{{ !empty($candidate->functional_area_id)?$candidate->functionalArea->name:__('messages.common.n/a') }}</p>
    </div>
    <div class="form-group col-sm-3">
