<div class="row">
    ...
    <div class="form-group col-sm-6">
        ...
        {{ Form::select('country_id', $data['countries'], isset($candidate)?$candidate->user->country:null, ['id'=>'countryId','class' => 'form-control','placeholder' => 'Select Country']) }}
    </div>
    <div class="form-group col-sm-6">
    ...
    <div class="form-group col-sm-6">
        ...
        {{ Form::text('phone', null, ['class' => 'form-control', 'onkeyup' => 'if (/\D/g.test(this.value)) this.value = this.value.replace(/\D/g,"")', 'minlength' => '10', 'maxlength' => '10']) }}
    </div>
    <div class="form-group col-sm-6">
    ...
    <div class="form-group col-sm-6">
        ...
        {{ Form::text('current_salary', isset($candidate) ? number_format($candidate->current_salary) : null, ['class' => 'form-control price-input']) }}
    </div>
    <div class="form-group col-sm-6">
        {{ Form::label('expected_salary', __('messages.candidate.expected_salary').':') }}
        {{ Form::text('expected_salary', isset($candidate) ? number_format($candidate->expected_salary) : null, ['class' => 'form-control price-input']) }}
    </div>
    <div class="form-group col-sm-6">
    ...
    <div class="form-group col-sm-6">
        ...
        {{ Form::textarea('address', isset($candidate) ? $candidate->address : null, ['class' => 'form-control','rows'=>'5']) }}
    </div>
    ...
    <div class="form-group col-sm-3 mb-0 pt-1">
        ...
        <label class="custom-switch pl-0">
            <input type="checkbox" name="is_verified" class="custom-switch-input"
                   value="1" id="verified" {{(isset($candidate) && ($candidate->user->is_verified)) ? 'checked' : ''}}>
            <span class="custom-switch-indicator"></span>
        </label>
    </div>
