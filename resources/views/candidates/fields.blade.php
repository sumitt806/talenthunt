<div class="row">
    ...
    <div class="form-group col-sm-6">
        ...
        {{ Form::text('current_salary', null, ['class' => 'form-control price-input']) }}
    </div>
    <div class="form-group col-sm-6">
        {{ Form::label('expected_salary', __('messages.candidate.expected_salary').':') }}
        {{ Form::text('expected_salary', null, ['class' => 'form-control price-input']) }}
    </div>
    <div class="form-group col-sm-6">
    ...
    <div class="form-group col-sm-6">
        ...
        {{ Form::radio('immediate_available', '1', true) }} {{ __('messages.candidate.immediate_available') }} <br>
