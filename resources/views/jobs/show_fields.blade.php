<div class="row details-page">
    ...
    <div class="form-group col-xl-6 col-md-6 col-sm-12">
        ...
        @if($job->jobsSkill->isNotEmpty())
            <p>{{ $job->jobsSkill->pluck('name')->implode(', ') }}</p>
        @else
    ...
    <div class="form-group col-xl-6 col-md-6 col-sm-12">
        ...
        @if($job->jobsTag->isNotEmpty())
            <p>{{ $job->jobsTag->pluck('name')->implode(', ') }}</p>
        @else
            <p>{{ __('messages.common.n/a') }}</p>
        @endif
    </div>
    ...
    <div class="form-group col-xl-6 col-md-6 col-sm-12">
        ...
        <p>{{ (!empty($job->careerLevel)) ? $job->careerLevel->level_name : __('messages.common.n/a') }}</p>
    </div>
    <div class="form-group col-xl-6 col-md-6 col-sm-12">
        {{ Form::label('job_shift_id', __('messages.job.job_shift').':') }}
        <p>{{ (!empty($job->jobShift)) ? $job->jobShift->shift : __('messages.common.n/a') }}</p>
    </div>
    <div class="form-group col-xl-6 col-md-6 col-sm-12">
    ...
    <div class="form-group col-xl-6 col-md-6 col-sm-12">
        ...
        <p>{{ (!empty($job->degreeLevel)) ? $job->degreeLevel->name : __('messages.common.n/a') }}</p>
    </div>
    <div class="form-group col-xl-6 col-md-6 col-sm-12">
