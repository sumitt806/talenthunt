    ...
    reader.onload = function (e) {
      ...
      image.onload = function () {
        if (image.height != 16 || image.width != 16) {
          ...
          $('#validationErrorsBox').html('The image must be of pixel 16 x 16.').show();
          return false;
        }
...
module.exports = __webpack_require__(/*! /Applications/MAMP/htdocs/InfyOm Product/infy-jobs/resources/assets/js/settings/settings.js */"./resources/assets/js/settings/settings.js");
