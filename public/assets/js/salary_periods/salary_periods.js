...
$(tableName).DataTable({
  ...
  columns: [{
    data: function data(row) {
      return '<a href="#" class="show-btn" data-id="' + row.id + '">' + row.period + '</a>';
    },
    name: 'period'
  }, {
    data: function data(row) {
    ...
    data: function data(row) {
      ...
      return prepareTemplateRender('#salaryPeriodActionTemplate', data);
    },
    name: 'id'
  }]
});
...
/***/ 7:
/*!********************************************************************!*\
  !*** multi ./resources/assets/js/salary_periods/salary_periods.js ***!
  \********************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! /Applications/MAMP/htdocs/InfyOm Product/infy-jobs/resources/assets/js/salary_periods/salary_periods.js */"./resources/assets/js/salary_periods/salary_periods.js");
