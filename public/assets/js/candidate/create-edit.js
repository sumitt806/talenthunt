...
$(document).ready(function () {
  ...
  $('#maritalStatusId, #countryId, #careerLevelId, #industryId, #functionalAreaId,#stateId,#cityId, #salaryCurrencyId, #skillId, #languageId').select2({
    'width': '100%'
  });
...
module.exports = __webpack_require__(/*! /Applications/MAMP/htdocs/InfyOm Product/infy-jobs/resources/assets/js/candidate/create-edit.js */"./resources/assets/js/candidate/create-edit.js");
