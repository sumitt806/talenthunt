...
$(tableName).DataTable({
  ...
  columns: [{
    data: function data(row) {
      ...
      return '<a href="' + showUrl + '" class="show-btn" data-id="' + row.id + '">' + row.title + '</a>';
    },
    name: 'title'
  }, {
    data: function data(row) {
...
module.exports = __webpack_require__(/*! /Applications/MAMP/htdocs/InfyOm Product/infy-jobs/resources/assets/js/blogs/blogs.js */"./resources/assets/js/blogs/blogs.js");
