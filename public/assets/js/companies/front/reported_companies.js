...
var tableName = '#reportedCompaniesTbl';
$(tableName).DataTable({
  scrollX: true,
  deferRender: true,
  scroller: true,
  ...
  columns: [{
    ...
    data: function data(row) {
      ...
      return prepareTemplateRender('#reportedCompanyActionTemplate', data);
    },
    name: 'id'
  }, {
    data: 'user.last_name',
...
$(document).on('click', '.delete-btn', function (event) {
  var reportedCompanyId = $(event.currentTarget).data('id');
  deleteItem(reportedCompaniesUrl + '/' + reportedCompanyId, tableName, 'Reported Company');
});
...
module.exports = __webpack_require__(/*! /Applications/MAMP/htdocs/InfyOm Product/infy-jobs/resources/assets/js/companies/front/reported_companies.js */"./resources/assets/js/companies/front/reported_companies.js");
